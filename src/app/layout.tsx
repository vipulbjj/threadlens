    ...
    >
      <body className="min-h-full flex flex-col bg-background text-foreground">
        <header className="px-6 h-16 flex items-center border-b border-white/5 backdrop-blur-md sticky top-0 z-50 bg-background/80">
          <a className="flex items-center justify-center transition-transform hover:scale-105" href="/">
          ...
          <nav className="ml-auto flex items-center gap-6">
            <a className="text-sm font-medium text-muted-foreground hover:text-white transition-colors" href="/upload">
              Upload
            </a>
            <a className="text-sm font-medium text-muted-foreground hover:text-white transition-colors" href="/dashboard">
              Dashboard
            </a>
            <a className="text-sm font-medium bg-white text-black px-4 py-2 rounded-full hover:bg-emerald-400 hover:text-black transition-all shadow-md" href="/upload">
              Start Free
            </a>
          </nav>
        </header>
